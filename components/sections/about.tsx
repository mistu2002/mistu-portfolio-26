...
const experience = [
  {
    ...
    period: "2025 - Present",
    description: "Crafted intuitive UI designs and visual assets for the brand.",
  ...
  },
  {
    ...
    period: "2025",
    description: "Led end-to-end design from architecture to web app.",
  ...
  },
  {
    ...
    role: "UI/UX Designer (Freelance)",
    period: "2024 - 2025",
    description: "Solo product and brand designer. Built identity, architecture, and mobile UI from vision to launch.",
    link: "", 
  },
  {
    ...
    period: "2023",
    description: "Designed motion graphics and animated assets to elevate client social campaigns",
