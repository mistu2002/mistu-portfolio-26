...
export function Footer() {
  return (
    <footer id="contact" className="mx-6 mb-6 rounded-[48px] relative bg-foreground text-background overflow-hidden">
      {/* Decorative Blob */}
        ...
        <div className="flex flex-col gap-12 md:gap-12">
          ...
          <div className="space-y-6">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-6xl md:text-6xl lg:text-6xl font-display font-bold tracking-tight leading-[0.9]"
            >
              Let&apos;s create
              <br />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-end">
            <div>
              <p className="text-xl md:text-m text-background/60 mb-4  max-w-lg">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 md:px-6 md:py-4 rounded-full text-l font-medium hover:scale-105 hover:rotate-2 transition-transform duration-300"
              >
                Let&apos;s chat
               ...
               <div className="flex gap-4">
                 {socialLinks.map((link) => (
                   <Link
                     ...
                     className="p-3 rounded-full border border-background/20 hover:bg-background hover:text-foreground transition-all duration-300 group"
                   >
